...
def loss_diffusion(model, img_batch, label_batch, marginal_prob_std,eps=1e-5, device = 'cuda' if torch.cuda.is_available() else 'cpu'):
    """
    ...
    score = model(img_batch= perturbed_img_batch, t = random_t, label_batch =label_batch)
